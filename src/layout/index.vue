...
.wrapper {
    ...
    .main-container {
        ...
        .main {
            ...
            flex: auto;
            position: relative;
            padding: $g-breadcrumb-height 0 0;
            overflow: hidden;
            transition: 0.3s;
        }
        .breadcrumb-container + .main {
            padding: calc(#{$g-breadcrumb-height}) 0 0;
        }
        .tabbar-container + .breadcrumb-container + .main {
            padding: calc(#{$g-tabbar-height} + #{$g-breadcrumb-height}) 0 0;
        }
    }
}
header + .wrapper {

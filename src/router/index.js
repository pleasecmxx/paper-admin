...
import FinanceManageRouters from './business-platform/finance-manage-routers';
import OrderManageRouters from './business-platform/order-manage-routers';
import SystemManageRouters from  './business-platform/system-manage-routers';
import UserManageRouters from './business-platform/user-manage-routers';

import ShopSystemConfig from './business-shop/system-manage-router';
import ShopOrderManage from './business-shop/order-manage-routers';
import ShopFinanceManageRouters from './business-shop/finance-manage-routers';

import AgentShopManage from './business-agent/shop-manage-routers';
import AgentOrderManage from './business-agent/order-manage-routers';
import AgentFinanceManageRouters from './business-agent/finance-manage-routers';
import AgentSystemManage from './business-agent/system-manage-routers';

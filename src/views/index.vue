    ...
    <div>
        <!-- <page-header title="欢迎使用 Fantastic-admin（专业版）">
            ...
            <el-button-group style="margin-right: 10px;">
                <el-button type="success" plain icon="ri-file-text-line" @click="open('https://hooray.gitee.io/fantastic-admin')">开发文档</el-button>
                <el-button type="primary" icon="ri-code-line" @click="open('https://gitee.com/hooray/fantastic-admin')">代码仓库</el-button>
            </el-button-group>
            <el-tooltip class="item" effect="dark" content="购买方式见下方" placement="bottom-end">
                <el-button type="primary" icon="ri-money-cny-circle-fill">购买</el-button>
            </el-tooltip>
        </page-header>
        <el-row :gutter="20" style="padding: 0 20px; margin-bottom: 20px;">
            <el-col :md="6">
                <ColorfulCard header="开发文档" :num="123" tip="较上周上升50%" icon="index-document" />
            </el-col>
            <el-col :md="6">
                <ColorfulCard color-from="#fbaaa2" color-to="#fc5286" header="基础组件" :num="12323" tip="较上周上升50%" icon="index-component" />
            </el-col>
            <el-col :md="6">
                <ColorfulCard color-from="#ff763b" color-to="#ffc480" header="扩展组件" :num="123" tip="较上周上升50%" icon="index-component" />
            </el-col>
            <el-col :md="6">
                <ColorfulCard color-from="#6a8eff" color-to="#0e4cfd" header="业务应用页面" :num="123" tip="较上周上升50%" icon="index-page" />
            </el-col>
        </el-row>
        <page-main>
            ...
            <el-row :gutter="20" style="margin-bottom: 20px;">
                ...
                <el-col :md="12" class="intro">
                    ...
                    <div class="answer">请先加作者 QQ ：304327508 ，备注来意，然后通过下方微信或支付宝进行支付，建议支付时备注上自己的 QQ 号，支付成功后会邀请进专业版客户群，可在群文件里下载专业版演示源码和模版源码。</div>
                    <div class="pay">
                        <div class="wechat">

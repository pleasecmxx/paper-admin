<template>
    <div>
        ...
        <div id="login-box">
            ...
            <el-form ref="form" :model="form" :rules="rules" size="default" class="flex-container login-form" auto-complete="on" label-position="left">
                <div class="title-container">
                    <h3 class="title">{{ title }}管理后台</h3>
                </div>
                <div>
                    <el-form-item prop="account">
                        <el-input ref="name" v-model="form.account" :placeholder="$t('app.account')" type="text" tabindex="1" auto-complete="on">
                            <svg-icon slot="prefix" name="user" />
                        </el-input>
                    </el-form-item>
                    <el-form-item prop="password">
                        <el-input ref="password" v-model="form.password" :type="passwordType" :placeholder="$t('app.password')" tabindex="2" auto-complete="on" @keyup.enter.native="handleLogin">
